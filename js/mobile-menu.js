document.addEventListener("DOMContentLoaded", () => {
  ...
  const navListRef = document.querySelector(".o-g-navigation-list");
  const headerRef = document.querySelector(".o-g-header");
  const navigationRef = document.querySelector(".o-g-navigation");
  ...
  document.querySelectorAll(".o-g-navigation-link").forEach((n) =>
...
function toggleAnswer(element) {
  ...
  const buttonImg = element.querySelector(".o-g-toggle-button img");
